...
#
# quote.pl
# hlu, Sep/17/2006 - Feb/5/2017

use strict;
use CGI;
use DBI;

my $DSN = 'DBI:mysql:quote_development:localhost';
...
# parameter could be removed some years later (check htaccess for usage before).
{
    ...
    my  $dbh = DBI->connect($DSN,user with read access, users password);
...
# print "\n\nstatement=\"@statement\"\n\n";
    ...
    print "<div class=\"quote\">" unless $content_only eq 'JavaScriptFunction';
    ...
    print "</div>";
    print "</div>" unless $content_only eq 'JavaScriptFunction';
